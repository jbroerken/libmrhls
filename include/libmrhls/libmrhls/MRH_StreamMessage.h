...
#define MRH_STREAM_MESSAGE_AUDIO_BUFFER_SIZE ((MRH_STREAM_MESSAGE_BUFFER_SIZE - sizeof(MRH_Uint32)) / sizeof(MRH_Sint16)) // In samples (*2 = bytes)
...
extern "C"
{
    ...
    {
        MRH_Uint32 u32_Size;
        MRH_Uint8 p_Buffer[MRH_STREAM_MESSAGE_CUSTOM_BUFFER_SIZE];
    ...
    typedef struct MRH_LS_M_Audio_Data_t
    {
        ...
        MRH_Sint16 p_Samples[MRH_STREAM_MESSAGE_AUDIO_BUFFER_SIZE]; // Mono
