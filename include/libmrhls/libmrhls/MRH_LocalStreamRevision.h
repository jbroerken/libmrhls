...
#ifndef MRH_LocalStreamRevision_h
#define MRH_LocalStreamRevision_h
...
extern "C"
{
    ...
    extern int MRH_GetLocalStreamLibraryVersionMajor(void);
    ...
    extern int MRH_GetLocalStreamLibraryVersionMinor(void);
    ...
    extern int MRH_GetLocalStreamLibraryVersionPatch(void);
...
#define MRH_LOCAL_STREAM_LIB_VERSION_PATCH 2


#endif /* MRH_LocalStreamRevision_h */
